    ...
    <div className="rounded-2xl border bg-white p-5 shadow-sm">
      <div className="mb-4">
        ...
        <h2 className="mt-1 text-xl font-bold text-gray-950">
          If this is not assigned, it remains your responsibility.
        </h2>
      </div>
            ...
            {districtScenario.map((row) => {
              ...
              return (
                <tr key={row.school + row.signal} className="border-t align-top">
                  ...
                  <td className={row.owner ? "p-3 font-medium text-gray-950" : "p-3 font-semibold text-red-700"}>
                    {owner}
                  </td>
                  <td className="p-3 text-gray-700">{row.due}</td>
                  <td className="p-3 text-gray-700">{row.evidence}</td>
                  <td className="p-3 font-semibold text-red-700">UNCONTAINED</td>
                  <td className="p-3">
