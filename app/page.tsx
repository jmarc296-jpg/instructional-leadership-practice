...
const pillars = [
  {
    label: "01",
    title: "Risk",
    body: "Identify leaders most likely to underperform before the system reacts too late."
  },
  {
    label: "02",
    title: "Prescription",
    body: "Convert leadership risk into specific intervention plans leaders can execute."
  },
  {
    label: "03",
    title: "Succession",
    body: "Know who is ready now, who needs development, and where vacancies create exposure."
  }
];
      ...
      <section className="mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 py-20 sm:px-10">
        <div className="max-w-5xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <Link
              href="/district-audit"
              className="inline-flex items-center justify-center rounded-full bg-black px-7 py-4 text-sm font-bold text-white transition hover:bg-neutral-800"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-neutral-300 bg-white/40 px-7 py-4 text-sm font-bold transition hover:border-black hover:bg-white"
            >
